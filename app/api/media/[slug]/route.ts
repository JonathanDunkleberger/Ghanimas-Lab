...
export async function GET(
  ...
  try {
    ...
    // explore_more intentionally NOT built here — it fans out to four other
    // APIs and made first-open feel broken. The panel fetches it separately
    // from /api/explore-more.
